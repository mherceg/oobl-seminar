...
namespace Tracktor.DAL.EFRepository
{
        ...
        where TEntity : class
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual DEntity GetByID(object id)
        {
        ...
        public virtual int Insert(DEntity entity)
        {
            //DbSet.Add(entity);
            throw new NotImplementedException();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IEnumerable<DEntity> GetAll()
        {
            throw new NotImplementedException();
        }
        ...
        public virtual DEntity GetSingle(Func<TEntity, bool> predicate)
        {
